...
# Form implementation generated from reading ui file 'd:\WorkSpace\PyqtProject\yolov7_tiny_obb_pyqt\dialog\rtsp_dialog.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":icon/实时视频流解析.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
